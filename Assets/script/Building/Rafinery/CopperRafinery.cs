public class CopperRafinery : Rafinery
{
    ...
    public void Start()
    {
        if (inputRessourcesType == null || inputRessourcesType.Length == 0)
        {
            ...
            inputRessourcesType[0] = new InputRessourcesType { nom = "Copper", inputQuantity = 1};
        }
        ...
        if (outputRessourcesType == null || outputRessourcesType.Length == 0)
        {
            ...
            outputRessourcesType[0] = new OutputRessourcesType { nom = "CopperIngot", outputQuantity = 1};
        }
    }
}
